...
use Carbon\Carbon;
class ExpectedPettyCashController extends Controller
{
    public function storeExpectedPettyCashValue(Request $request, $projectId)
    {
        $request->validate([
        ...
        $monthlyValueRecord = ExpectedPettyCashValue::firstOrCreate(
     ...
     */
    public function calculateCumulativeExpectedPettyCashValue($projectId)
    {
        ...
        $monthlyReports = ExpectedPettyCashValue::where('projectId', $projectId)
     ...
     */
    public function getExpectedPettyCashValue(Request $request, $projectId)
    {
        $monthMapping = [
            'January' => 'jan',
            'February' => 'feb',
        ...
        $monthlyValueRecord = ExpectedPettyCashValue::where('projectId', $projectId)
                                             ->where('year', $currentYear)
                                             ->first();
