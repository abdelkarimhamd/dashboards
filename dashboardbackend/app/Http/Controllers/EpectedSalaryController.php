...
use Carbon\Carbon;
class EpectedSalaryController extends Controller
{
    public function storeExpectedSalaryValue(Request $request, $projectId)
    {
        $request->validate([
        ...
        $monthlyValueRecord = ExpectedSalaryValue::firstOrCreate(
     ...
     */
    public function calculateCumulativeExpectedSalaryValue($projectId)
    {
        ...
        $monthlyReports = ExpectedSalaryValue::where('projectId', $projectId)
     ...
     */
    public function getExpectedSalaryValue(Request $request, $projectId)
    {
        $monthMapping = [
            'January' => 'jan',
            'February' => 'feb',
        ...
        $monthlyValueRecord = ExpectedSalaryValue::where('projectId', $projectId)
                                             ->where('year', $currentYear)
                                             ->first();
