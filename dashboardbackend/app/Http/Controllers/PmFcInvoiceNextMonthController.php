...
class PmFcInvoiceNextMonthController extends Controller
{
    /**
     * Store the invoice value for the current month
     */
    public function storePmFcNextMonthMonthValue(Request $request, $projectId)
    {
        $request->validate([
        ...
        $monthlyValueRecord = PmFcInvoiceCurrentMonth::firstOrCreate(
     ...
     */
    public function calculatePmFcNextMonthMonthValue($projectId)
    {
        ...
        $monthlyReports = PmFcInvoiceCurrentMonth::where('projectId', $projectId)
     ...
     */
    public function getPmFcNextMonthMonthValue(Request $request, $projectId)
    {
        $monthMapping = [
            'January' => 'jan',
            'February' => 'feb',
        ...
        $monthlyValueRecord = PmFcInvoiceCurrentMonth::where('projectId', $projectId)
                                             ->where('year', $currentYear)
                                             ->first();
