...
class CreateActualinvoiceTable extends Migration
{
    public function up()
    {
        Schema::create('actualinvoice', function (Blueprint $table) {
            $table->id('actualinvoiceID');
    ...
    {
        Schema::dropIfExists('actualinvoice');
    }
}
